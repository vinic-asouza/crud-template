...
import { updateClienteRequest } from '../../store/modules/cliente/actions';
...
export default function AtualizaCliente(cliId) {
  ...
  return (
    <SmallContent grid="4">
      ...
      <Aux>
        <Form initialData={cliente} onSubmit={handleSubmit}>
          <ul>
            <li>
